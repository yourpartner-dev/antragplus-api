...
vi.mock('../../../helpers/system-data/inde.js', () => ({ appAccessMinimalPermissions: mocks.appAccessMinimalPermissions }));
vi.mock('../../../helpers/utils/filter-items.js');
vi.mock('../../../helpers/utils/merge-permissions.js');
