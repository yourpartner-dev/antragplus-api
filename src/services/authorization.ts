...
import { validatePayload } from '../helpers/utils/validate-payload.js';
...
import { getRelationInfo } from '../helpers/utils/get-relation-info.js';
...
export class AuthorizationService {
	...
	constructor(options: AbstractServiceOptions) {
		...
		this.payloadService = new PayloadService('yp_permissions', {
			knex: this.knex,
			schema: this.schema,
		});
	}
