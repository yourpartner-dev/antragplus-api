...
import type { Accountability, Item, PrimaryKey } from '../types/index.js';
import { uniq } from 'lodash-es';
import { useLogger } from '../helpers/logger/index.js';
import type { AbstractServiceOptions, MutationOptions } from '../types/index.js';
import { getPermissions } from '../helpers/utils/get-permissions.js';
...
`;
					...
					if (isYPError(err, ErrorCode.Forbidden)) {
