...
import type { BusboyFileStream, PrimaryKey } from '../types/index.js';
...
router.use(useCollection('yp_files'));
...
export const multipartHandler: RequestHandler = (req, res, next) => {
	 ...
	 * the row in yp_files async during the upload of the actual file.
	 */
...
const readHandler = asyncHandler(async (req, res, next) => {
	...
	const meta = await metaService.getMetaForQuery('yp_files', req.sanitizedQuery);
