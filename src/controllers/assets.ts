...
import { InvalidQueryError, RangeNotSatisfiableError } from '../helpers/errors/index.js';
...
import { getCacheControlHeader } from '../helpers/utils/get-cache-headers.js';
...
router.get(
	...
	asyncHandler(async (req, res, next) => {
		const payloadService = new PayloadService('yp_settings', { schema: req.schema });
