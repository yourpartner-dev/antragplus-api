...
import { isYPError, ErrorCode, ForbiddenError, InvalidPayloadError } from '../helpers/errors/index.js';
...
router.use(useCollection('yp_activity'));
...
const readHandler = asyncHandler(async (req, res, next) => {
	...
	const meta = await metaService.getMetaForQuery('yp_activity', req.sanitizedQuery);
