...
import type { SchemaInspector } from '../../database/schema/index.js';
import { createInspector } from '../../database/schema/index.js';
import { systemCollectionRows } from '../system-data/index.js';
import type { Filter, SchemaOverview } from '../../types/index.js';
import { parseJSON, toArray } from './index.js';
...
async function getDatabaseSchema(database: Knex, schemaInspector: SchemaInspector): Promise<SchemaOverview> {
	...
	for (const [collection, info] of Object.entries(schemaOverview)) {
		...
		const collectionMeta:any = collections.find((collectionMeta) => collectionMeta.collection === collection);
