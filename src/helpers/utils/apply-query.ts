import { NUMERIC_TYPES } from '../../types/index.js';
...
import { getFilterOperatorsForType, getFunctionsForType, getOutputTypeForFunction, isIn } from '../../helpers/utils/index.js';
 ...
 *
 * ```json
 * // Fetch pages that have articles written by Omi
 *
 * {
 *   "articles": {
 *     "author": {
