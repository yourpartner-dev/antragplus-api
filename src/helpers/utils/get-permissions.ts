...
import type { Accountability, Permission, SchemaOverview } from '../../types/index.js';
import { deepMap, parseFilter, parseJSON, parsePreset } from './index.js';
import { cloneDeep } from 'lodash-es';
import hash from 'object-hash';
import { getCache, getCacheValue, getSystemCache, setCacheValue, setSystemCache } from '../../cache.js';
import getDatabase from '../../database/index.js';
import { appAccessMinimalPermissions } from '../system-data/index.js'
...
export async function getPermissions(accountability: Accountability, schema: SchemaOverview) {
	...
	if (accountability.admin !== true) {
		const query = database.select('*').from('yp_permissions');
