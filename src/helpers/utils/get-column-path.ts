import type { Relation, SchemaOverview } from '../../types/index.js';
...
/**
 * Converts a YourPartner field list path to the correct SQL names based on the constructed alias map.
 * For example: ['author', 'role', 'name'] -> 'ljnsv.name'
 * Also returns the target collection of the column: 'yp_roles'
