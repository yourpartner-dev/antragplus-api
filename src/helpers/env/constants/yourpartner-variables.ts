/**
 * Variables in the environment that yourpartner will read as configuration
 */
export const YP_VARIABLES = [
	// general
	'CONFIG_PATH',
	'HOST',
	'PORT',
...
/**
 * Variables in the environment that yourpartner will read as configuration in RegExp format
 */
export const YP_VARIABLES_REGEX = YP_VARIABLES.map((name) => new RegExp(`^${name}$`));
